#pragma checksum "D:\Projet Asp.net mvc\How-To\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8e6b789ef3ec39873cf7b307d6061f6d580e132a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8e6b789ef3ec39873cf7b307d6061f6d580e132a", @"/Views/Home/Index.cshtml")]
                            ...
                            <div class=""featured-box"">
                                <div class=""fb-heading"">
                                    ...
                                    <div class=""fb-sub-heading"">
                                        <b>New to gomac?</b> Watch the video below to get started
                                        <br>
                                    </div>
                                </div>
                                <hr class=""style-three"">
                                <div class=""fb-content"">
                                    <iframe src=""https://player.vimeo.com/video/144748647"" width=""100%"" height=""360"" frameborder=""0"" webkitallowfullscreen mozallowfullscreen
   ...
   ");
            WriteLiteral(@"             <!-- END LATEST VIDEO TUTORIAL AREA -->
       ...
       ");
            WriteLiteral(@"                                     <a href=""single-article.html"">
                                                <i class=""fa fa-file-text-o""></i> How to change account password?
                                            </a>
                                        </li>
                                        <li>
                                            <a href=""single-article.html"">
                                                <i class=""fa fa-file-text-o""></i> How to edit order details?
                                            </a>
                                        </li>
                                        <li>
                                            <a href=""single-article.html"">
                                        ...
                                        <li>
                                            <a href=""");
            WriteLiteral(@"single-article.html"">
                                                <i class=""fa fa-file-text-o""></i> Change customer details
                                            </a>
                                        </li>
                                        <li>
                                            <a href=""single-article.html"">
                                                <i class=""fa fa-file-text-o""></i> Lookup existing customer in order form
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class=""col-md-6 margin-bottom-20"">
                                <div class=""fat-heading-abb"">
                                    <a href=""single-category.html"">
                                        ...
                                        <span cla");
            WriteLiteral(@"ss=""cat-count"">(6)</span>
                                    </a>
                                </div>
                                <div class=""fat-content-small padding-left-30"">
                                    <ul>
                                        ...
                                        <li>
                                            <a href=""single-article.html"">
       ");
            WriteLiteral(@"                                         <i class=""fa fa-file-text-o""></i> Add new user
                                            </a>
                                        </li>
                                        <li>
                                            <a href=""single-article.html"">
                                ...
                                <div class=""fat-content-small padding-left-30"">
                                    <ul>
                                        ...
                                        <li>
                                            <a href=""single-article.html"">
                                             ");
            WriteLiteral(@"   <i class=""fa fa-file-text-o""></i> How to edit order details?
                                            </a>
                                        </li>
                                        <li>
                                            <a href=""single-article.html"">
                                        ...
                                        <li>
                                            <a href=""single-article.html"">
                                                <i class=""fa fa-file-text-o""></i> Lookup existing c");
            WriteLiteral(@"ustomer in order form
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class=""col-md-6 margin-bottom-20"">
                                ...
                                <div class=""fat-content-small padding-left-30"">
                                    <ul>
                                        <li>
                                            <a href=""single-article.html"">
                                                <i class=""fa fa-file-text-o""></i> How to change ac");
            WriteLiteral(@"count password?
                                            </a>
                                        </li>
                                        <li>
                                            <a href=""single-article.html"">
            ...
            WriteLiteral(@"       </a>
                            ...
                            <div class=""col-md-6 margin-bottom-20"">
                                ...
                                <div class=""fat-content-sma");
            WriteLiteral(@"ll padding-left-30"">
                                    <ul>
                                        <li>
                                            <a href=""single-article.html"">
                                                <i class=""fa fa-file-text-o""></i> How to change account password?
            ...
            WriteLiteral(@"           </li>
                            ...
                            <div class=""col-md-6 margin-bottom-20"">
                                <div class=""fat-heading-abb"">
                                    <a href=""single-category.html"">
                   ");
            WriteLiteral(@"                     <i class=""fa fa-folder""></i> Configurations
            ...
            <div class=""col-md-4 padding-20"">
                ...
                <div class=""");
            WriteLiteral(@"row margin-top-20"">
                    <div class=""col-md-12"">
            ...
            WriteLiteral(@"    </div>
                        ...
                        <div class=""fat-content-small padding-left-10"">
                            <ul>
                                <li>
                                    <a href=""#"">
                                        <i class=""fa fa-file-text-o""></i> How to change username?
                                    </a>
                                </li>
                                <li>
                                    <a href=""#"">
                                        <i class=""fa fa-file-text-o""></i> How to change currency in gomac?
                                    </a>
                                </li>
                                <li>
                                    <a href=""#"">
 ...
 ");
            WriteLiteral(@"                                   <a href=""#"">
                                        <i class=""fa fa-file-text-o""></i> How to print stock barcode?
                                    </a>
                                </li>
                                <li>
                                    <a href=""#"">
                                        <i class=""fa fa-file-text-o""></i> How to generate barcode?
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            WriteLiteral(@">
                            ...
                            <a hre");
            WriteLiteral(@"f=""#"" class=""btn btn-default btn-o btn-sm"">campaign</a>
    ...
    <div class=""container-fluid featured-a");
            WriteLiteral(@"rea-grey padding-30"">
        <div class=""container"">
            <div class=""row"">
                <div class=""col-md-12"">
                    <div class=""fb-heading"">
                    ...
                    <div class=""fb-content"">
                        ...
                        <p>
                            Sed eget ultricies lectus. Nulla in portti");
            WriteLiteral(@"tor libero. Suspendisse potenti. Etiam iaculis in augue eu volutpat. Pellentesque
